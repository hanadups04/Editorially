...
const EditRequestsModal = ({
  ...
  return (
    <div className="admin-overlay" onClick={onClose}>
      <div
        className="admin-modal edit-requests-modal"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="admin-header">
          <h2 className="admin-title">Edit Requests</h2>
                  ...
                  <div className="request-card-header">
                    <div className="request-author">
                      <div className="request-author-avatar">
                        {request.users_tbl.username
                          .split(" ")
                          .map((n) => n[0])
                          .join("")}
                      </div>
                      <div className="request-author-info">
                        <span className="request-author-name">
                          {request.requestedBy}
                        </span>
                    ...
                    <span
                      className={`request-urgency-badge ${request.isUrgent ? "urgent" : "normal"}`}
                    >
